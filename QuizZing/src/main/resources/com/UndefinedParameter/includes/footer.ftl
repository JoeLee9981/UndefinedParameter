	...
	<div id="footer-content" class="page-content metro">
		<div id="bottom-links" class="grid fluid">
			<nav class="horizontal-menu compact">
			    <ul>
			        <li><a href="#" class="todo">About</a></li>
			        <li><a href="#" class="todo">Register</a></li>
			        <li><a href="#" class="todo">Login</a></li>
			        <li><a href="/orgs">Organizations</a></li>
			        <li><a href="#" class="todo">Groups</a></li>
			        <li><a href="#" class="todo">Contact</a></li>
