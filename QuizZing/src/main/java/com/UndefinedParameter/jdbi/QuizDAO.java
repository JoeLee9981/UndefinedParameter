...
public interface QuizDAO {
	 ...
	 */
	@SqlUpdate("INSERT INTO Quiz (CreatorID, Difficulty, Rating, Description, Time) VALUES(:creatorId, :diff, :rating, :desc, :time)")
	@GetGeneratedKeys
	public long createQuiz(@Bind("creatorId") long creatorId, @Bind("diff") float diff, @Bind("rating") double rating, @Bind("desc") String desc, @Bind("time") int time);
